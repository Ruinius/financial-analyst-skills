...
3. **Sticky Customer Relationships**: Multi-year contracts and deep integration into bank workflows create substantial barriers to exit, ensuring stable and predictable revenue streams.
...
3. **Transition Year Bottoming**: 2026 is designated as a transition year, with margins expected to bottom before a very gradual recovery toward 34% by 2030.
...
3. **Segment Headwinds**: Recent performance (Q1 2026) already shows organic revenue declines in the Merchant and Financials segments (down 1% and 6% respectively), confirming the downward trend.
