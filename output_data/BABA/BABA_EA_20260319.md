...
| Confidence          | high   |
| Original Filename   | Alibaba Group Announces December Quarter 2025 Results.pdf     |
...
|---|-----------|-------|--------|
| 1 | Amortization and impairment of intangible assets | 841.0 | GAAP Reconciliation |
| 2 | Impairment of goodwill, and others | 9515.0 | GAAP Reconciliation |
| 3 | Amortization and impairment of intangible assets | 841.0 | Income Statement |
| 4 | Impairment of goodwill | 9515.0 | Income Statement |
...
| Field | Value |
|-------|-------|
| Net Working Capital | -203395.0 |
| Net Long-Term Operating Assets | 302121.0 |
| Invested Capital | 98726.0 |
| Capital Turnover | 11.54x |
| Calculation Date | 2026-04-29 |
...
|-----------|-------|-------|
| Operating Current Assets | Prepayments, receivables and other assets | 231761.0 |
| Operating Current Liabilities | Income tax payable, Accrued expenses, accounts payable and other liabilities, Merchant deposits, Deferred revenue and customer advances | 435156.0 |
| **Net Working Capital** | | **-203395.0** |
...
| Component | Items | Total |
|-----------|-------|-------|
| Operating Noncurrent Assets | Prepayments, receivables and other assets, Property and equipment, net | 352807.0 |
| Operating Noncurrent Liabilities | Deferred revenue, Deferred tax liabilities | 50686.0 |
| **Net Long-Term Operating Assets** | | **302121.0** |
...
| Field | Value |
|-------|-------|
| Income Before Taxes | 23875.0 |
| Income Tax Expense | -8460.0 |
| Net Income | 15631.0 |
| Effective Tax Rate | 35.43% |
| Adjusted Tax Rate | 26.98% |
| Calculation Date | 2026-04-29 |
...
|---|-----------|-------|------------|--------|---------------|
| 1 | Amortization and impairment of intangible assets | 841.0 | 0.00 | GAAP Reconciliation | 0% |
| 2 | Impairment of goodwill, and others | 9515.0 | 0.00 | GAAP Reconciliation | 0% |
| 3 | Amortization and impairment of intangible assets | 841.0 | 0.00 | Income Statement | 0% |
| 4 | Impairment of goodwill | 9515.0 | 0.00 | Income Statement | 0% |
| | **Reported Tax** | **-8460.0** | | | |
| | **Total Tax Adjustment** | | **0.00** | | |
| | **Adjusted Tax** | **-8460.00** | | | |
...
| **Effective Tax Rate** | 35.43% | |
| **Adjusted Tax Rate** | 26.98% | |
| **NOPAT** | 22897.00 | Using Adjusted Tax Rate |
| **Net Working Capital** | -203395.0 | |
| **Net Long-Term Operating Assets** | 302121.0 | |
| **Invested Capital** | 98726.0 | |
| **Capital Turnover** | 11.54x | Annualized |
| **ROIC** | 92.77% | Annualized |
| **Interest Expense** | -2557.0 | |
| **Basic Shares Outstanding** | 18568.0 | |
| **Diluted Shares Outstanding** | 19310.0 | |
| **Simple Revenue Growth** | 1.67% | YoY |
| **Organic Revenue Growth** | 9.00% | Constant currency |
