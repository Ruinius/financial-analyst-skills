...
> **Examples folder for THIS skill:** `skills/financial_modeling/json_export/examples/`
...
- List every `.md` file in `skills/financial_modeling/json_export/examples/`
...
- **Delete all other example files** from `skills/financial_modeling/json_export/examples/`.
