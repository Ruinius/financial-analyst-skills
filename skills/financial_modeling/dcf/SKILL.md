...
> **Examples folder for THIS skill:** `skills/financial_modeling/dcf/examples/`
...
- List every `.md` file in `skills/financial_modeling/dcf/examples/`
...
- **Delete all other example files** from `skills/financial_modeling/dcf/examples/`.
