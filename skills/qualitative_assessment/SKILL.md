...
> **Examples folder for THIS skill:** `skills/qualitative_assessment/examples/`
...
- List every `.md` file in `skills/qualitative_assessment/examples/`
...
- **Delete all other example files** from `skills/qualitative_assessment/examples/`.
