...
> **Examples folder for THIS skill:** `skills/financial_calculations/invested_capital/examples/`
...
- List every `.md` file in `skills/financial_calculations/invested_capital/examples/`
...
- **Delete all other example files** from `skills/financial_calculations/invested_capital/examples/`.
